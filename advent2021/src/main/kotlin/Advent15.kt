...
class Advent15(lines: List<String>) : IAdvent {
    ...
    private fun Pair<Int, Int>.neighbours(extended: Collection<Point> = emptySet(),
                                          matrix: List<List<Int>>): List<Point> {
        return listOf(
